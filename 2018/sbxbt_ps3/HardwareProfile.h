...
#define OUTPUT_PIN          0
    	...
    	// LCD Module I/O pins
    	#define PWMA_TRIS   (TRISAbits.TRISA0)
    	#define PWMA_IO		(LATAbits.LATA0)
    	#define PWMB_TRIS   (TRISAbits.TRISA1)
    	#define PWMB_IO		(LATAbits.LATA1)
    	#define AIN1_TRIS   (TRISAbits.TRISA2)
    	#define AIN1_IO		(LATAbits.LATA2)
    	#define AIN2_TRIS   (TRISAbits.TRISA3)
    	#define AIN2_IO		(LATAbits.LATA3)
    	#define BIN1_TRIS   (TRISAbits.TRISA4)
    	#define BIN1_IO		(LATAbits.LATA4)
    	#define BIN2_TRIS   (TRISBbits.TRISB5)
    	#define BIN2_IO		(LATBbits.LATB5)

    	#define SARB1_TRIS  (TRISBbits.TRISB2)
    	#define SARB1_IO	(LATBbits.LATB2)
    	#define SARB2_TRIS  (TRISBbits.TRISB3)
    	#define SARB2_IO	(LATBbits.LATB3)
    	#define SARB3_TRIS  (TRISBbits.TRISB4)
    	#define SARB3_IO	(LATBbits.LATB4)

    	#define LEDG3_TRIS  (TRISBbits.TRISB7)
    	#define LEDG3_IO	(LATBbits.LATB7)
    	#define LEDB3_TRIS  (TRISBbits.TRISB8)
    	#define LEDB3_IO	(LATBbits.LATB8)
    	#define LEDR3_TRIS  (TRISBbits.TRISB9)
    	#define LEDR3_IO	(LATBbits.LATB9)
